...
class Wxpay_WxPayApi
{
	...
	public static function unifiedOrder($inputObj, $timeOut = 6)
	{
		...
		$curtime = time();
		$inputObj->SetTime_start(date('YmdHis', $curtime));
	...
	function formatBizQueryParaMap($paraMap, $urlencode){
                ...
                $reqPar = $reqPar . '&key=' . WxPayConfig::KEY;
                return $reqPar;
        }

        function createPaySign($para) {
                $String = $this->formatBizQueryParaMap($para, false);
                return md5($String);
        }
}
